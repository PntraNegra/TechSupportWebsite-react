...
function WifiEn() {
    ...
    return (
        ...
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col">
                    <h5 className="mb-3">To connect to wi-fi, look for the setting in the bottom lower right hand corner, and click where indicated in the picture.</h5>
                </div>
                <img className="img-fluid mb-3" src="/imgEnglish/connect_wifi.png" alt="Connecting to Wifi" />
            </div>
            <div className="row row-content">
                <div className="col">
                    <h5 className="mb-3">Next, click on the setting indicated in the picture. This will open up your wi-fi settings.</h5>
                </div>
                <img className="img-fluid mb-3" src="/imgEnglish/connect_wifi_2.png" alt="Connecting to Wifi" />
            </div>
            <div className="row row-content">
                <div className="col">
                    <h5 className="mb-3">Look for your connection within the available connections. When you find your connection, click on it and put in your wi-fi password.
            ...
            <div className="row row-content">
                <div className="col">
                    <h5 className="mb-3">Congratulations, you are connected to the internet!</h5>
                </div>
            </div>
        </div>
